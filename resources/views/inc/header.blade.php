...
<h4 style="margin-top: 14px;font-weight: 700;">Blog system</h4>
            <style>
            ul {
            ...
            <ul>
            <li class="dropdown">
                <a href="javascript:void(0)" class="dropbtn">Hi, {{ Auth::user()->name }}</a>
            ...
            <div class="relative flex items-top justify-center bg-gray-100 sm:items-center py-4 sm:pt-0">
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block reg_des">
